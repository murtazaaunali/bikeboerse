...
let AccountService = class AccountService {
    constructor(httpClient, toastController, loadingController, router) {
    ...
    getAllPremiumOptions() {
        return this.httpClient.get(this.baseUrl + '/account/getallpremium.php')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => this.log('response received')), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getCategories', [])));
    }
    getPremiumOption(id) {
        return this.httpClient.get(this.baseUrl + '/account/getpremiumbyid.php?id=' + id)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => this.log('response received')), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getCategories', [])));
    }
    registerUser(nickname, name, surname, email, password, picture = 0, fb_access_token = 0, fb_user_id = 0) {
...
let VideosService = class VideosService {
    ...
    getVideos() {
        ...
        return this.httpClient.get(this.videos_url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => this.log('response received')), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getVideos', [])));
    }
    getLatestVideos() {
        this.videos_url = this.baseUrl + '/product/getallvideos.php?limit=0,10&orderby=title';
        return this.httpClient.get(this.videos_url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => this.log('response received')), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getLatestVideos', [])));
    }
    handleError(operation = 'operation', result) {
        return (error) => {
            // TODO: send the error to remote logging infrastructure
