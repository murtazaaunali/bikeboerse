...
var PoliciesPage = /** @class */ (function () {
    function PoliciesPage(iab) {
        this.iab = iab;
    }
    PoliciesPage.prototype.openNotifications = function () { };
    PoliciesPage.prototype.openDataProtection = function () {
        var browser = this.iab.create('https://bikeboerse.com/faq/');
        browser.close();
    };
    PoliciesPage.prototype.openTermsofUse = function () {
        var browser = this.iab.create('https://bikeboerse.com/faq/');
        browser.close();
    };
    PoliciesPage.prototype.openCopyrights = function () {
        var browser = this.iab.create('https://bikeboerse.com/faq/');
        browser.close();
    };
    PoliciesPage.prototype.openHelp = function () {
        var browser = this.iab.create('https://bikeboerse.com/faq/');
        browser.close();
    };
    PoliciesPage.prototype.openReportFault = function () {
        var browser = this.iab.create('https://bikeboerse.com/faq/');
        browser.close();
    };
    PoliciesPage.prototype.ngOnInit = function () {
    };
    PoliciesPage.ctorParameters = function () { return [
...
//# sourceMappingURL=policies-policies-module-es5.js.map