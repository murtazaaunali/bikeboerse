...
const routes = [
    ...
    { path: 'home', loadChildren: () => Promise.all(/*! import() | home-home-module */[__webpack_require__.e("default~add-product-add-product-module~chat-chat-module~chats-chats-module~edit-product-edit-product~45f09b4d"), __webpack_require__.e("common"), __webpack_require__.e("home-home-module")]).then(__webpack_require__.bind(null, /*! ./home/home.module */ "./src/app/home/home.module.ts")).then(m => m.HomePageModule) },
...
let AppComponent = class AppComponent {
    constructor(router, platform, splashScreen, statusBar, authenticationService) {
        this.router = router;
...
let AuthenticationService = class AuthenticationService {
    constructor(router, storage, platform, httpClient, toastController, fb) {
        this.router = router;
...
let ProductsService = class ProductsService {
    ...
    getProducts(limit = '0,10', order = 'title') {
        return this.httpClient.get(this.baseUrl + '/product/readproductwithlimitorder.php?limit=' + limit + '&orderby=' + order)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => this.log('response received')), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getProducts', [])));
    }
    ...
    getProductsByUserWatchlist(userId) {
    ...
    createProduct(product) {
        return this.httpClient.post(this.baseUrl + '/product/insertproduct.php', product)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => this.log('response received')), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('createProduct', [])));
    }
