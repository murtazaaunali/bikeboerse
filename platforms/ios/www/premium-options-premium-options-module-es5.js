...
var PremiumOptionsPageModule = /** @class */ (function () {
    function PremiumOptionsPageModule() {
    }
    ...
    return PremiumOptionsPageModule;
}());
...
var PremiumOptionsPage = /** @class */ (function () {
    function PremiumOptionsPage(accountService) {
        var _this = this;
        this.accountService = accountService;
        this.accountService.getAllPremiumOptions().subscribe(function (options) {
            _this.options = options['records'];
            console.log(_this.options);
        });
    }
    PremiumOptionsPage.prototype.ngOnInit = function () {
    };
    PremiumOptionsPage.ctorParameters = function () { return [
...
//# sourceMappingURL=premium-options-premium-options-module-es5.js.map