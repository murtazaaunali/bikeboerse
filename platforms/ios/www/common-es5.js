...
var AccountService = /** @class */ (function () {
    ...
    AccountService.prototype.getAllPremiumOptions = function () {
        ...
        return this.httpClient.get(this.baseUrl + '/account/getallpremium.php')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return _this.log('response received'); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getCategories', [])));
    };
    AccountService.prototype.getPremiumOption = function (id) {
        var _this = this;
        return this.httpClient.get(this.baseUrl + '/account/getpremiumbyid.php?id=' + id)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return _this.log('response received'); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getCategories', [])));
    };
    AccountService.prototype.registerUser = function (nickname, name, surname, email, password, picture, fb_access_token, fb_user_id) {
        var _this = this;
    ...
    AccountService.prototype.presentToastWithOptions = function (header, message) {
...
var VideosService = /** @class */ (function () {
    ...
    /** Log a HeroService message with the MessageService */
    VideosService.prototype.log = function (message) {
        console.log(message);
    };
    VideosService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
