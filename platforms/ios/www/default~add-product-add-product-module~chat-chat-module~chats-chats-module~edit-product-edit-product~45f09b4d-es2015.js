...
let CategoriesCarouselComponent = class CategoriesCarouselComponent {
    constructor() {
        this.slideOpts = {
            slidesPerView: 3
        };
...
let GoogleAdsComponent = class GoogleAdsComponent {
    constructor() { }
    ngOnInit() { }
};
...
let VideoCarouselComponent = class VideoCarouselComponent {
    constructor() {
        this.slideOpts3 = {
            slidesPerView: 1
        };
...
let VideoFilterComponent = class VideoFilterComponent {
    constructor() { }
    ngOnInit() { }
};
