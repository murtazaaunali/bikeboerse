...
var ProductPage = /** @class */ (function () {
    function ProductPage(route, productService) {
        ...
        this.productService.getProduct(this.id).subscribe(function (products) {
            _this.product = products.records;
