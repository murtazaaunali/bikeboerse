...
var ProductPage = /** @class */ (function () {
    function ProductPage(route, productService) {
        ...
        this.productService.getProduct(this.id).subscribe(function (product) {
            console.log(product);
            _this.title = product.title;
            _this.price = product.price;
            _this.paypal = product.paypal;
            _this.pickup = product.pickup;
            _this.brand = product.brand;
            _this.size = product.size;
            _this.fork = product.fork;
            _this.user = product.user;
            _this.images = product.filename;
            _this.desc = product.desc;
            _this.baseprice = product.baseprice;
        });
    }
