...
var map = {
	"./add-product/add-product.module": [
		...
		"default~add-product-add-product-module~chat-chat-module~chats-chats-module~edit-product-edit-product~45f09b4d",
		"add-product-add-product-module"
	],
	"./chat/chat.module": [
	...
	"./my-products/my-products.module": [
	...
	"./premium-option/premium-option.module": [
		"./src/app/premium-option/premium-option.module.ts",
		"default~add-product-add-product-module~chat-chat-module~chats-chats-module~edit-product-edit-product~45f09b4d",
		"premium-option-premium-option-module"
	],
	"./premium-options/premium-options.module": [
...
var routes = [
    ...
    { path: 'home', loadChildren: function () { return Promise.all(/*! import() | home-home-module */[__webpack_require__.e("default~add-product-add-product-module~chat-chat-module~chats-chats-module~edit-product-edit-product~45f09b4d"), __webpack_require__.e("common"), __webpack_require__.e("home-home-module")]).then(__webpack_require__.bind(null, /*! ./home/home.module */ "./src/app/home/home.module.ts")).then(function (m) { return m.HomePageModule; }); } },
    { path: 'search', loadChildren: './search/search.module#SearchPageModule' },
    { path: 'messages', loadChildren: './messages/messages.module#MessagesPageModule' },
    { path: 'my-products', loadChildren: './my-products/my-products.module#MyProductsPageModule', canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    ...
    { path: 'wishlist', loadChildren: './wishlist/wishlist.module#WishlistPageModule', canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    { path: 'policies', loadChildren: './policies/policies.module#PoliciesPageModule' },
    { path: 'my-account', loadChildren: './my-account/my-account.module#MyAccountPageModule', canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    { path: 'login', loadChildren: './login/login.module#LoginPageModule' },
    { path: 'register', loadChildren: './register/register.module#RegisterPageModule' },
    { path: 'settings', loadChildren: './settings/settings.module#SettingsPageModule', canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    ...
    { path: 'add-product', loadChildren: './add-product/add-product.module#AddProductPageModule', canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    ...
    { path: 'edit-product', loadChildren: './edit-product/edit-product.module#EditProductPageModule', canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
];
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                ...
                _services_products_service__WEBPACK_IMPORTED_MODULE_11__["ProductsService"],
...
var AuthenticationService = /** @class */ (function () {
    function AuthenticationService(router, storage, platform, httpClient, toastController, fb) {
        var _this = this;
        this.router = router;
    ...
    AuthenticationService.prototype.login = function (username, password) {
        ...
        this.httpClient.get(this.baseUrl + 'username=' + username + '&passwrod=' + password)
            ...
            console.log(data);
            _this.storage.set('USER_INFO', data[0]).then(function (response) {
    ...
    AuthenticationService.prototype.presentToastWithOptions = function (header, message) {
...
var ProductsService = /** @class */ (function () {
    ...
    ProductsService.prototype.getProducts = function (limit, order) {
        var _this = this;
        if (limit === void 0) { limit = '0,10'; }
        if (order === void 0) { order = 'title'; }
    ...
    ProductsService.prototype.getProductsByUser = function (userId) {
        var _this = this;
        return this.httpClient.get(this.baseUrl + '/product/readbyuser.php?userid=' + userId)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return _this.log('response received'); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getProducts', [])));
    };
    ProductsService.prototype.getProductsByUserWatchlist = function (userId) {
        var _this = this;
    ...
    ProductsService.prototype.createProduct = function (product) {
        ...
        return this.httpClient.post(this.baseUrl + '/product/insertproduct.php', product)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return _this.log('response received'); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('createProduct', [])));
    };
...
module.exports = __webpack_require__(/*! /Users/murtaza/Desktop/Data/IonicApps/MoutainBikeApp/BikeBoerse/BikeBoerse/src/main.ts */"./src/main.ts");
